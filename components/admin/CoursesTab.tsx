    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
         <div>
            ...
            <p className="text-xs text-gray-500">Create, edit, and organize curriculum content.</p>
         </div>
         <button 
           onClick={() => {
             setEditingCourse({
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {courses.map(course => (
          <div key={course.id} className="group bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col">
            <div className="h-40 bg-gray-100 relative overflow-hidden">
               ...
               <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button onClick={() => {setEditingCourse(course); setIsModalOpen(true);}} className="p-2 bg-white/90 rounded-full text-gray-700 hover:text-blue-600 shadow-sm">
                    <Edit2 size={16}/>
                  </button>
                  <button onClick={() => { if(confirm('Delete course?')) deleteCourse(course.id); }} className="p-2 bg-white/90 rounded-full text-gray-700 hover:text-red-600 shadow-sm">
                    <Trash2 size={16}/>
                  </button>
               </div>
            ...
            <div className="p-5 flex-1 flex flex-col">
              <h4 className="text-gray-900 font-bold mb-1 line-clamp-1 text-lg">{course.title}</h4>
              ...
              <div className="mt-auto flex items-center justify-between border-t border-gray-100 pt-4">
                 <span className="text-xs font-medium text-gray-500">{course.lessons.length} Lessons</span>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
             ...
             <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
               <div>
                  ...
                  <p className="text-xs text-gray-500">Manage lessons, quizzes, and resources.</p>
               </div>
             ...
             <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-80 border-r border-gray-200 p-6 overflow-y-auto bg-white">
                   ...
                   <div className="space-y-4">
                      ...
                      <div>
                         <label className="text-xs font-bold text-gray-700 block mb-1.5">Instructor Name</label>
                      ...
                      <div>
                         <label className="text-xs font-bold text-gray-700 block mb-1.5">Subject Category</label>
                      ...
                      <div>
                         <label className="text-xs font-bold text-gray-700 block mb-1.5">Cover Image URL</label>
                      ...
                      <div>
                         <label className="text-xs font-bold text-gray-700 block mb-1.5">Price (EGP)</label>
                   ...
                   <div className="max-w-3xl mx-auto">
                      <div className="flex justify-between items-center mb-6">
                         ...
                         <button 
                           ...
                           className="text-sm font-bold text-brand-blue bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg transition-colors border border-blue-200"
                         >
                           + Add Lesson
                         </button>
                      </div>
                      ...
                      <div className="space-y-4">
                         ...
                         {editingCourse.lessons?.map((lesson, lIdx) => (
                           <div key={lesson.id} className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden transition-all">
                              {/* Lesson Header */}
                              <div 
                                className="p-4 flex items-center gap-4 bg-white cursor-pointer hover:bg-gray-50"
                              ...
                              >
                                 ...
                                 <input 
                                   ...
                                   className="flex-1 font-bold text-gray-900 bg-transparent outline-none border-b border-transparent focus:border-blue-500"
                                 ...
                                 <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                                    <button 
                                      ...
                                      className={`text-xs px-2 py-1 rounded font-bold border ${lesson.isLocked ? 'bg-gray-100 border-gray-300 text-gray-600' : 'bg-green-50 border-green-200 text-green-700'}`}
                                    >
                              ...
                              {expandedLesson === lesson.id && (
                                 <div className="p-6 border-t border-gray-100 bg-gray-50/50 space-y-6 animate-in slide-in-from-top-2">
                                    
                                    {/* 1. Resources Section */}
                                    <div>
                                       <h5 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Lesson Resources</h5>
                                       <div className="space-y-3">
                                          {lesson.contents.map((content, cIdx) => (
                                             <div key={content.id} className="flex gap-2 items-center">
                                                ...
                                                <select 
                                                  ...
                                                  className="bg-white border border-gray-200 rounded text-xs py-1.5 px-2 outline-none"
                                                >
                                                ...
                                                <input 
                                                  ...
                                                  className="flex-1 bg-white border border-gray-200 rounded text-xs py-1.5 px-3 outline-none focus:border-blue-500"
                                          ...
                                          <div className="flex gap-2 mt-2">
                                             <button 
                                               onClick={() => {
                                                  const ls = [...editingCourse.lessons!];
                                                  ls[lIdx].contents.push({id: 'c'+Date.now(), type: 'video', title: 'New Video', url: ''});
                                                  setEditingCourse({...editingCourse, lessons: ls});
                                               }}
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-4">
                                       <div className="flex justify-between items-center mb-4">
                                          ...
                                          <div className="flex gap-2">
                                             <label className="cursor-pointer text-xs font-bold text-gray-600 hover:text-gray-900 flex items-center gap-1 px-3 py-1.5 bg-gray-100 rounded-md hover:bg-gray-200 transition-colors">
                                             ...
                                             <div key={q.id} className="bg-gray-50 border border-gray-200 rounded p-3">
                                                <div className="flex gap-2 mb-2">
                                                   ...
                                                   <textarea 
                                                     ...
                                                     className="flex-1 bg-white border border-gray-200 rounded p-2 text-sm outline-none focus:border-blue-500 resize-none h-16"
                                                   ...
                                                   {q.options.map((opt, oIdx) => (
                                                      <div key={oIdx} className="flex items-center gap-2">
                                                         ...
                                                         <input 
                                                           ...
                                                           className={`flex-1 text-xs border rounded px-2 py-1 outline-none ${q.correctOptionIndex === oIdx ? 'border-green-300 bg-green-50' : 'border-gray-200'}`}
